...
class CircleChanger(object):
    ...
    def __init__(self, x, y, radius, fill_color, colors):
        ...
        self.circle = circle
        self.colors = colors
        self.originalcolor = circle.fill_color
        self.index = 0
    ...
    def get_distance_from(self, point):
        ...
        ################################################################
        return math.sqrt((self.circle.center.x - point.x) ** 2 + (
            self.circle.center.y - point.y) ** 2)
    ...
    def swallow(self, other_circle_changer):
        ...
        #   NO CREDIT if you use the distance formula here.
        ################################################################
        newcenterx=(self.circle.center.x+other_circle_changer.circle.center.x)/2
        newcentery=(self.circle.center.y+other_circle_changer.circle.center.y)/2
        ...
        new = CircleChanger(newcenterx, newcentery, newradius, 'red',
                            newcolors)
        return new
    ...
    def change_to_original_color(self):
        ...
        #   (below).  Third, implement and test this method.
        ################################################################
        self.circle.fill_color = self.originalcolor
